...
Revision ID: d241b881f848
Revises: 406c99961233
Create Date: 2026-05-25 10:33:04.626975
...
revision: str = 'd241b881f848'
down_revision: Union[str, Sequence[str], None] = '406c99961233'
...
def upgrade() -> None:
    ...
    sa.Column('ativo', sa.Boolean(), nullable=True),
    sa.Column('imagem_path', sa.String(length=250), nullable=True),
